...
#Subsetting to just include plots and their total biomass (excluding reps)
df_C2_KNZ.noreps <- df_C2_KNZ.clean %>% 
  distinct(year, plot, plot_biomass, .keep_all = T)
df_C2_KNZ.noreps <- df_C2_KNZ.noreps[-c(6:9)]
df_C2_KNZ.noreps <- df_C2_KNZ.noreps[-c(6)]
