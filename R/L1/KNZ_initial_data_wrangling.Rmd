...
F1_AB_spp_soil$uniqueid<-paste(F1_AB_spp_soil$year, F1_AB_spp_soil$higher_order_organization, F1_AB_spp_soil$plot, sep="_")
...
F2_mass$uniqueid<-paste(F2_mass$year, F2_mass$higher_order_organization, F2_mass$plot, sep="_")
