...
write.csv(KNZ_specieslevel_abundance,file.path(L1_dir,"/KNZ_specieslevel_abundance_L1.csv"))

#checking abundance duplicate
species_check<-read.csv(file.path(L1_dir, "KNZ_specieslevel_abundance_L1.csv")) %>%
...
#upload to google drive
write.csv(KNZ_plotlevel_metrics,file.path(L1_dir,"/KNZ_plotlevel_metrics_L1.csv"))
...
#upload to google drive
write.csv(KNZ_metadata,file.path(L1_dir,"/KNZ_metadata_L1.csv"))
