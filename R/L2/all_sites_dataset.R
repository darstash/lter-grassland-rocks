...
species_abundance2 <- species_abundance %>%
  mutate(
    ...
    species = case_when(species %in% "Acalyp virgi"                   ~ "Acalypha virginica",
                        ...
                        species %in% "Symphy ssp."                    ~ "Symphyotrichum ssp.",
                        ...
                        species %in% c("Miscellaneous woody plants") ~ "Unknown woody ssp.",
                        ...
                        species %in% c("Miscellaneous herbs",
                                       ...
                                       "Forbs",
                                       "Miscellaneous forbs",
                                       "Miscellaneous herbs")       ~ "Unknown forb ssp.",
                        species %in% c("Miscellaneous grasses 2",
                                       "Miscellaneous grass",
                                       "Unknown grass",
                                       "Unknown grass 1",
                                       "Unknown sedge")             ~ "Unknown grass sp.",
...
# maybe_plant_things_in_biomass <- c("1st year woody",
#                                    "Annual forb",
#                                    "Another unknown dicot",
#                                    "Acer spp.",
#                                    "Miscellaneous sp.",
...
# 
# 
# not_plant_things_in_biomass <- c("Bare_ground",
#                                  "Dung",
#                                  "Lichen",
#                                  "Litter",
#                                  "Miscellaneous woody litter",
...
results %>% 
  filter(!Name_matched_rank %in% c("species", "variety")) %>%
  filter(!Unmatched_terms %in% "sp.") %>%
  select(Name_submitted, Name_matched, Genus_submitted, Genus_matched, Accepted_family, Unmatched_terms, WarningsEng) %>%
